...
* @{
*/
#define PRODUCT_KEY "6ce4102e1aaa410b96975334e0c8c346"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "3a90a4bb45404359becf40a0d0f4d048"
...
* @{
*/
#define Watering_BYTEOFFSET                    0
#define Watering_BITOFFSET                     0
#define Watering_LEN                           1
#define Automatic_BYTEOFFSET                    0
#define Automatic_BITOFFSET                     1
#define Automatic_LEN                           1
#define Warning_BYTEOFFSET                    5
#define Warning_BITOFFSET                     0
...
typedef struct {
  uint8_t flagWatering:1;
  uint8_t flagAutomatic:1;
} attrFlags_t;
